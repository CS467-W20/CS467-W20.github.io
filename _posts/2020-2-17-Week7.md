...
Since this specific vulnerability has to do with serialization we will tackle it in our next week on "Insecure Deserialization".  

### Analysis 
Prevent a known vulnerabilities attacks by:     
- Continuosly monitor sources like CVE and NVD.     
